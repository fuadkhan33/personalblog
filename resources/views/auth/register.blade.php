...
@section('content')
<div class="container cus-log-reg-margin">
    <div class="row justify-content-center card-mar-cus">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="first_name" type="text" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="first_name" value="{{ old('first_name') }}" required>
